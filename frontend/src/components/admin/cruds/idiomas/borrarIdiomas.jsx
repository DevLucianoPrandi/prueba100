...
function BorrarIdiomas() {
    ...
    const handleSubmit = (idiomaData) => {
        deleteIdioma(idiomaData = { nombre: nombre, descripcion: descripcion, paises: paises, boton: boton, imagen: `storage/imgs/` + inputFileRef.current.files[0] })
    ...
    return (
        ...
        >
            ...
            <Modal show={show} onHide={handleClose} animation={false}>
                ...
                <Modal.Footer>
                    <Button variant="primary" type="submit" onClick={handleSubmit}>Borrar idioma</Button>
